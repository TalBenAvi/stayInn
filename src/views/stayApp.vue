<template>
  <div class="stay-app">
    ...
    <section v-if="staysForDisplay" class="grid-card-container">
      ...
      <div class="grid-card-item">
        <img class="grid-img" src="../assets/imgs/home-page/homes/cabin/1.jpeg" />
        <p class="stay-name">
          {{ staysForDisplay[0].name }}, {{ staysForDisplay[0].loc.address }}
        </p>
        <p class="stay-details-display">
      ...
      <div class="grid-card-item">
        <img class="grid-img" src="../assets/imgs/home-page/homes/camper/1.jpeg" />
        <p class="stay-name">
          {{ staysForDisplay[0].name }}, {{ staysForDisplay[0].loc.address }}
        </p>
        <p class="stay-details-display">
          ...
          {{ staysForDisplay[0].beds }} bed ∙ {{ staysForDisplay[0].bath }} bath
            ...
            <div class="grid-card-item">
        <img class="grid-img" src="../assets/imgs/home-page/homes/kezhan/2.jpeg" />
        <p class="stay-name">
          {{ staysForDisplay[0].name }}, {{ staysForDisplay[0].loc.address }}
        </p>
        <p class="stay-details-display">
      ...
      <div class="grid-card-item">
        <img class="grid-img" src="../assets/imgs/home-page/homes/trullo/1.jpeg" />
        <p class="stay-name">
          {{ staysForDisplay[0].name }}, {{ staysForDisplay[0].loc.address }}
        </p>
        <p class="stay-details-display">
